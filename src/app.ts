...
import corteRoutes from './routes/corte.routes';
import corteDiarioRoutes from './routes/corteDiario.routes';
...
app.use(`/api/${API_VERSION}/cortes`, corteRoutes);
app.use(`/api/${API_VERSION}/cortes-diarios`, corteDiarioRoutes);
