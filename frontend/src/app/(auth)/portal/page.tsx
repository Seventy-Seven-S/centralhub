    ...
    <div className="min-h-screen flex items-center justify-center px-4" style={{ backgroundColor: '#0F1F3D' }}>
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-sm mt-1" style={{ color: '#9BB0D0' }}>Portal de Clientes</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <input
                ...
                style={{ backgroundColor: '#0F1F3D', border: '1px solid #2A4A70' }}
              />
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 rounded-lg text-sm font-semibold transition-all duration-150 flex items-center justify-center gap-2 disabled:opacity-60 disabled:cursor-not-allowed"
        ...
        <p className="text-center mt-6 text-sm" style={{ color: '#9BB0D0' }}>
          ¿Eres del equipo?{' '}
          <Link href="/login" className="font-medium transition-colors hover:text-white" style={{ color: '#C9972C' }}>
            Accede aquí
          </Link>
        </p>
